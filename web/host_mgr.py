...
class MultiTask(object):
    ...
    def run_cmd(self):
        ...
        print '==>',cmd,host_ids,task_expire_time,self.request.user.userprofile.name
        ...
        print '====script:',settings.MultiTaskScript
    ...
    def file_send(self):
        ...
        task_obj= self.create_task_log('file_send',exec_hosts,task_expire_time,content)
        print '====script:',settings.MultiTaskScript,task_type
