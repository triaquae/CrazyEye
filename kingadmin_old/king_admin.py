...
from kingadmin_old.admin_base import BaseKingAdmin,site
...
class TaskLogAdmin(BaseKingAdmin):
    ...
    def log_details(self):
        '''日志详情'''
        ele = '''<a class='btn-link' href='/kingadmin_old/web/tasklogdetail/?child_of_task=%s'>详情</a> ''' % self.instance.id
        return ele
